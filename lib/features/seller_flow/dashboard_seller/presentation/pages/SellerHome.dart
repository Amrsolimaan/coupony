...
class SellerHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<SellerHomeCubit, SellerHomeState>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: (state is SellerHomeGuest || state is SellerHomePending)
  ...
  Widget _buildBody(
    ...
    // ── Normal Home Content ────────────────────────────────────────────────
    return _buildHomeContent(context, l10n);
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── Title ──────────────────────────────────────────────────────
            Text(
              l10n.seller_home_content_title,
              textAlign: TextAlign.center,
              style: AppTextStyles.customStyle(
                context,
                fontSize: 20,
            ...
            // ── Subtitle ───────────────────────────────────────────────────
            Text(
              l10n.seller_home_content_subtitle,
              textAlign: TextAlign.center,
              style: AppTextStyles.customStyle(
                context,
                fontSize: 14,
  ...
  void _handleNavigation(
    ...
    if (state is SellerHomeInitial) {
      isGuest = state.isGuest;
      isPending = state.isPending;
    } else if (state is SellerHomeLoaded) {
      isGuest = state.isGuest;
      isPending = state.isPending;
    } else if (state is SellerHomeGuest) {
      isGuest = true;
    } else if (state is SellerHomePending) {
      isPending = true;
    }
