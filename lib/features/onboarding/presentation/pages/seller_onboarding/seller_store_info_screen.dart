...
/// Seller Store Info Screen (UI ONLY - No Cubit/Repository)
/// Step 1 of 4 in Seller Onboarding Flow
...
class _SellerStoreInfoScreenState extends State<SellerStoreInfoScreen> {
  ...
  void _onNext() {
    if (_isValid) {
      Navigator.pushNamed(context, '/seller_price_range');
    }
  }
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12.r),
            borderSide:
                BorderSide(color: _theme.primaryColor, width: 1.5.w),
          ),
        ),
      ),
    );
